						...
						<form role="form" action="AnimeHelper" method="POST" id="form_set"
								...
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordion"
											href="#collapseOne" id="query_condition"> Query Condition <script>
												document
									...
									<div class="panel-body">
										...
										<div class="form-group">
											<label class="text" for="anime_name">Anime Name</label> <input
												...
												name="Text_anime_name" placeholder="Please input anime name, leave it as it is if not be specified."
										...
										<div class="form-group">
											<label class="checkbox-inline"> <input
												...
												${Checkbox_start_time=="on"?"checked":""}>Release Date
											</label> <label class="checkbox-inline"> <input
												type="checkbox" id="Checkbox_company"
												name="Checkbox_company"
												${Checkbox_company=="on"?"checked":""}>Production Company
											</label><label class="checkbox-inline"> <input
												type="checkbox" id="Checkbox_episode_number"
												name="Checkbox_episode_number"
												${Checkbox_episode_number=="on"?"checked":""}>Number of Episode
											</label><label class="checkbox-inline"> <input
												...
												${Checkbox_scriptwriter_name=="on"?"checked":""}>Script Writer
											</label>
											<!-- <label class="checkbox-inline"> <input
							...
							<div class="panel panel-primary">
								<div class="panel-heading">
									...
									<h4 class="panel-title">
										Query Result <span style="float: right" class="controls-row"> <!-- <label for="page_content_number" >每页显示</label> -->
											<select class="form-control" name="page_content_number"
											style="max-height: 30px;" onchange="submitFun('form_set')">
												<option value="5" ${page_content_number=="5"?'selected':''}>5 items per page</option>
												<option value="10"
													${page_content_number=="10"?'selected':''}>10 items per page</option>
												<option value="25"
													${page_content_number=="25"?'selected':''}>25 items per page</option>
												<option value="50"
													${page_content_number=="50"?'selected':''}>50 items per page</option>
										</select>
										</span>
									</h4>
								</div>
										...
										<c:when test="${!empty page_idx && page_idx > 0}">
											...
											<div class="row txt">
												...
												<strong><span class="label label-info col-md-2"
													style="min-height: 10px;">Page ${page_idx } /
														Page ${ResultPageCount}</span></strong>
